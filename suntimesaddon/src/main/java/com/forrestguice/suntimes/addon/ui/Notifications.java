...
{
    @TargetApi(26)
    public static String createNotificationChannel(Context context, String channelID, int titleResID, int descResID, int importance) {
    ...
    @TargetApi(26)
    public static String createNotificationChannel(Context context, String channelID, int titleResID, int descResID, int importance, @Nullable Uri soundUri, @Nullable AudioAttributes audioAttribs) {
     ...
     * @param soundUri nullable uri
     * @param audioAttrs nullable attrs
     * @return channelID
     */
    @TargetApi(26)
    public static String createNotificationChannel(Context context, String channelID, String title, String desc, int importance, @Nullable Uri soundUri, @Nullable AudioAttributes audioAttrs)
    {
